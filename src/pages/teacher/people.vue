  ...
  <el-container class="home-container">
    ...
    <el-header>
      <div class="header_logo">
        <img src="../../assets/img/LoginImg/logo.png"
             alt="">
        <span>海大云统战</span>
      </div>
      <div class="header_right">
        <div class="userinfo">
          <img src="../../assets/img/bigSummary/用户-圆.png"
               alt="">
          <p>当前用户:{{user}}</p>
        </div>
        <div class="help">
          <img src="../../assets/img/bigSummary/空心问号.png"
               alt="">
          <p>用户指南</p>
        </div>
        <div class="exit"
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
        <div class="toggle-button"
             @click="toggleCollapse">|||人物库</div>
        <!-- 侧边栏菜单区域 -->
        <!-- router表示以每个菜单的index作为路由进行跳转 -->
        <el-menu background-color="#282b34"
                 text-color="#fff"
